<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="teacher_changep.ascx.vb" Inherits="ECA_WEB.teacher_changep" %>
    ...
    <!-- The following labels are used to show warnings if any input is invalidated.-->
      <div class ="container">
        ...
        ********************************************************************-->
        ...
        <asp:RequiredFieldValidator  ValidationGroup ="vgmanaadmin"  CssClass="text-danger " runat ="server" ForeColor  ="Red"  Font-Bold="true" Font-Size="X-Small"   Font-Italic ="true" ControlToValidate ="username" text="You must enter your current account."/><br /><br />
        ...
        <asp:RequiredFieldValidator  ValidationGroup ="vgmanaadmin"  CssClass="text-danger " runat ="server" ForeColor  ="Red"  Font-Bold="true" Font-Size="X-Small"   Font-Italic ="true" ControlToValidate ="oldpassword" text="You must enter your current password"/><br /><br />
        ...
        <asp:RequiredFieldValidator  ValidationGroup ="vgmanaadmin"  CssClass="text-danger " runat ="server" ForeColor  ="Red"  Font-Bold="true" Font-Size="X-Small"   Font-Italic ="true" ControlToValidate ="newpassword" text="You must enter your new password."/><br /><br />
        ...
        <asp:RequiredFieldValidator  ValidationGroup ="vgmanaadmin"  CssClass="text-danger " runat ="server" ForeColor  ="Red"  Font-Bold="true" Font-Size="X-Small"   Font-Italic ="true" ControlToValidate ="newpasswordconfirmation" text="You must enter your new password confirmation."/><br /><br />
